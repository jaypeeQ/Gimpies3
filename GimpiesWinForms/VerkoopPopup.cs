...
namespace GimpiesWinForms
{
    public partial class VerkoopPopup : Form
    {
        ...
        {
            //Makes sure the entered values are in numerical values.
            try
            {
            ...
            //Makes sure the entered value in Shoe Number is avaialble.
            ...
            {
                MessageBox.Show("That Shoe number was not found. Please input existing shoe number available.");
                return;
        ...
        //Fills the datagrid with the data from the ShoeInventory.dbo
